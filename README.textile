h2. Redmine Default Columns plugin
...
1. Please *do* remove folder _redmine_default_columns_ completely before installing new version
2. Follow the Redmine plugin installation steps at: http://www.redmine.org/wiki/redmine/Plugins
3. Restart your Redmine web servers (e.g. mongrel, thin, mod_rails)
4. Login as administrator and configure the plugin (Administration > Plugins > Configure)
